...
module ClientSideProgram=
    ...
    let connect () =
            try
                ...
                let data : byte[] = System.Text.Encoding.ASCII.GetBytes("Hello From Client")
                while true do
                    let connectionThread = new Thread(fun () -> checkConnection(tcpClient))
            ...
            | BreakException -> printf "CLIENT IS DISCONNECTED FROM SERVER !"
            | NotConnectedException -> printf "SERVER CONNECTRION "
        // }
